...
int main()
{
   ...
   Up:
        printf("\n\n Welcome To My Singly Linear Case Study..!");
       ...
       {
         case '1':
             printf("\n Enter Value To Insert At First Position in LL : ");
             scanf("%d",&Num);
         ...
         case '2':
             printf("\n Enter Value To Insert At Last Position in LL : ");
             scanf("%d",&Num);
         ...
         case '3':
             printf("\n Enter Location Insert Value LL Between(1 to %d) : ",LL_Ele_Cnt);
             scanf("%d",&Loc);
